...
def main():
    ...
    parser.add_argument("--tif", help="Path to input .tif file", default="/media/zzd/hrhsr/backup/Documents/img_seg/River/data/data_2023/p4/10_23/p4-10-23-all-process_transparent_mosaic_group1.tif")
    parser.add_argument("--tiles_dir", help="Folder to save split tiles", default="/media/zzd/hrhsr/backup/Documents/img_seg/River/data/data_2023/p4/10_23/split_tmp/")
    parser.add_argument("--merged_dir", help="Folder to save stitched full-size JPG", default="/media/zzd/hrhsr/backup/Documents/img_seg/River/data/data_2023/p4/10_23/")
    parser.add_argument("--downscaled_dir", help="Folder to save downscaled JPG", default="/media/zzd/hrhsr/backup/Documents/img_seg/River/data/data_2023/p4/10_23/")
    parser.add_argument("--split_ratio", type=int, default=5, help="Splits per axis (default: 3)")
